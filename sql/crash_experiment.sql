...
ALTER TABLE
    public.crash_experiment OWNER to ricardo;

COMMENT ON TABLE public.crash_experiment IS 'Main table holding individual crash experiments.';

COMMENT ON COLUMN public.crash_experiment.network_figure IS 'Binary figure storage.';

COMMENT ON COLUMN public.crash_experiment.network_pos IS 'Network figure node positions. It can be used for visualizations.';
